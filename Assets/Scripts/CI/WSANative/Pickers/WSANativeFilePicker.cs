...
namespace CI.WSANative.Pickers
{
	public static class WSANativeFilePicker
	{
		...
		public static void PickMultipleFiles(string commitButtonText, WSAPickerViewMode viewMode, WSAPickerLocationId suggestedStartLocation, string[] filters, Action<IEnumerable<WSAStorageFile>> response)
		{
		}
